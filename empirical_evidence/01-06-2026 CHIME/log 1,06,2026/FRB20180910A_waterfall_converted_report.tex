...
\maketitle
\begin{abstract}
В данной работе представлены результаты многомасштабного спектрального анализа архивного файла FRB20180910A_waterfall_converted.npz. Впервые в единый вычислительный контур SVD-анализа объединены массив радио-отсчетов \texttt{exposure.npy} и пространственная матрица инкремента лучей \texttt{beam\_inc\_exp.npy}. Максимальная зарегистрированная деформация 21D-многообразия составила 36.6712\%. Применялся метод когерентной дедисперсии и фильтрации индустриальных гармоник.
\end{abstract}
...
\begin{itemize}
  \item Имя исходного архива: \texttt{FRB20180910A_waterfall_converted.npz}
  \item Инкремент луча телескопа (Beam Data): \textbf{Интегрирован (3.8 ГБ)}
  \item Конфигурация SVD-капкана: $W = 10$, $T = 1$
  \item Мера дисперсии плазмы (DM): $0.0$ пк/см$^3$
...
\midrule
  1 & 400000000.00012 & 51.50 & 3.60 & 27.78 & 3.142 \\
  2 & 400000000.12463 & 39.59 & 1.86 & 53.89 & 0.000 \\
\bottomrule
\end{tabular}
\end{table*}
...
\centering
  \begin{subfigure}[b]{0.9\textwidth}
    \includegraphics[width=\textwidth]{FRB20180910A_waterfall_converted_macro.png}
    \caption{Контур I: Макро-масштаб временных транзитов (секунды).}
  \end{subfigure}\\ [0.3cm]
  \begin{subfigure}[b]{0.9\textwidth}
    \includegraphics[width=\textwidth]{FRB20180910A_waterfall_converted_micro.png}
    \caption{Контур II: Микро-масштаб (микросекунды, электроника/UAP).}
  \end{subfigure}\\ [0.3cm]
  \begin{subfigure}[b]{0.9\textwidth}
    \includegraphics[width=\textwidth]{FRB20180910A_waterfall_converted_nano.png}
...
\begin{equation}
S(f) = 1.41e+05 \cdot \exp\left( -\frac{(f - 400000000.000)^2}{2 \cdot 27.78^2} \right) \cdot e^{-i \cdot 3.142} + 6.17e+04
\end{equation}
